...
if __name__ == '__main__':
    ...
    parser.add_argument('--log_dir', type=str, default='logs/randaugment/vit_base_patch16_224_16')
    args = parser.parse_args()

    args.target_size = args.image_size // 4 if 'patch16' in args.model_name else args.image_size // 2

    # data
    train_dataset = lib.dataset_randaugment_gus.OMCDataset(args.train_h5_path, args.image_size, args.target_size, args.sigma)
