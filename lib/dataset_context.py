...
species_cls = {'Japanese_macaque': 0, 'Rhesus_macaque': 1, 'Olive_baboon': 2, 'Gibbon': 3, 'Golden_lion_tamarin': 4, 'Common_marmoset': 5, 'Bonobo': 6, 'Siamang': 7, 'Crab-eating_macaque': 8, 'Vervet_monkey': 9, 'Orangutan': 10, 'Gorilla': 11, 'Chacma_baboon': 12, 'Chimpanzee': 13, 'Golden_snub-nosed_monkey': 14, 'Hamadryas_baboon': 15, 'Cotton-top_tamarin': 16, 'Proboscis_monkey': 17, 'Barbary_macaque': 18, 'Dusky_leaf_monkey': 19, 'Squirrel_monkey': 20, 'Emperor_tamarin': 21, 'Tufted_capuchin': 22, 'Mandrill': 23, 'Lion-tailed_macaque': 24, 'Formosan_rock_macaque': 25}
...
class OMCDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, item):
        ...
        assert data['species'] in species_cls
        cls = species_cls[data['species']]

        return image, target, metadata, cls
