...
def main():
    ...
    parser.add_argument('--output_dir', type=str, default='output/val_h5_randaugment/')
    ...
    dataset = lib.dataset_randaugment.OMCDataset(args.h5_path, args.image_size, args.target_size, sigma=1)
