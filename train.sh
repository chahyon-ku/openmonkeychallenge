...
# python train.py --sigma 8 --magnitude 4 --n_upscales 2 --log_dir logs/1212-10/base_sig8_mag4_up2 --n_epochs 10 --device cuda:0
...
# python train_context.py --sigma 8 --magnitude 4 --n_upscales 2 --log_dir logs/1212-10/context_sig8_mag4_up2 --n_epochs 10 --device cuda:0 --f_save=10

# python train_context.py --model_name vit_large_patch16_224 --sigma 8 --magnitude 2 --n_upscales 3 --log_dir logs/1212-20/lc_sig8_mag2_up3 --n_epochs 80 --device cuda:0 --context --f_save=10
python train_context.py --model_name vit_large_patch16_224 --sigma 8 --magnitude 4 --n_upscales 4 --log_dir logs/1212-20/lc_sig8_mag4_up4 --n_epochs 80 --device cuda:0 --context --f_save=10