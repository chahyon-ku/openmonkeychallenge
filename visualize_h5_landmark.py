...
def main():
    ...
    parser.add_argument('--output_dir', type=str, default='output/landmark_s8_m4/')
    ...
    dataset = lib.dataset.OMCDataset(args.h5_path, args.image_size, args.target_size, sigma=8, magnitude=4)
